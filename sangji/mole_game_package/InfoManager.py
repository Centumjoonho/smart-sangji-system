...
from project.settings import MOLE_IMAGE_URL, KO_FONT_URL
...
class InformationManager():
    ...
    def __init__(self, goal_to_complete):
        ...
        self.bg_img = cv2.imread(os.path.join(MOLE_IMAGE_URL,'bg_white.png'), cv2.IMREAD_COLOR)
    ...
    def display_game_info(self, window_size_height, window_size_width):
        ...
        font=ImageFont.truetype(KO_FONT_URL, 30)
